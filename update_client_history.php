    ...
    <div id="wrap">
       ...
       <div id="left">
            ...
            <ul id="menu" class="collapse">
                ...
                <li><a href="tables.html"><i class="icon-table"></i> Change Password </a></li>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Click on the update link to update client tracking history
                        </div>
...
require_once('includes/connection.class.php');
       ...
       $stmt = $conn->prepare("SELECT * FROM buyer_tb");
		...
		while($row = $stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			<td align="center">
			<a id="<?php echo $id; ?>" href="#update_history<?php echo $id; ?>" data-toggle="modal" class="btn btn-success" title = "update"> <span class=" glyphicon glyphicon-open"></span> 
			Update Track
            </a> 
			
			
			
			<?php include('modal_update_client.php'); ?>
			</td>
