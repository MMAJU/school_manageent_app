    ...
    <div id="wrap">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                         ...
                         <ul class="dropdown-menu dropdown-user">
                            ...
                            <li><a href="change_password.php"><i class="icon-gear"></i> Change Password </a>
                            </li>
                            <li class="divider"></li>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Enter the Tracking Number to Edit.
                        </div>
											...
											<th>Last Location</th>
												<th>Date</th>
													<th>Remarks</th>
														<th>Status</th>
														<th>Edit History</th>
														<th>Delete History <span class=" glyphicon glyphicon-trash"></span></th>
       ...
       if($result1 = $conn->query($query1)){
		while($row1 = $result1->fetch(PDO::FETCH_ASSOC))
		{
			...
			<td align="center">
			<a id="<?php echo $id; ?>" href="#ehistory<?php echo $id; ?>" data-toggle="modal" class="btn btn-success" title = "edit tracking info"> <span class=" glyphicon glyphicon-edit"></span> 
			Edit Track info
            </a> 
			
			<?php include('modal_edit_history.php'); ?>
				...
				<td align="center">
                   	...
                   	<a id="<?php echo $id; ?>" href="delete.php?id= <?php echo $id; ?>" class="btn btn-warning" onClick="return confirm('Are you sure you want to delete?')" title = "Delete tracking info"> <span class=" glyphicon glyphicon-trash"></span> 
			Delete Track info
            </a>                 
