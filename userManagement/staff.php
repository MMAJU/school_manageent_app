											...
											<tr>
												...
												<td class="text-end">
													...
													<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
														...
														<div class="menu-item px-3">
															<a href="<?php echo './userManagement/assign_class_staff.php?id='.urlencode($staff_id) ; ?>" class="menu-link px-3">Assign Class</a>
															
														</div>

														<div class="menu-item px-3">
															<a href="<?php echo './userManagement/assign_staff_subject.php?id='.urlencode($staff_id) ; ?>" class="menu-link px-3">Assign Subj</a>
															
														</div>
														<div class="menu-item px-3">
															<a href="<?php echo './userManagement/view_staff_subject.php?id='.urlencode($staff_id) ; ?>" class="menu-link px-3">View Subj</a>
