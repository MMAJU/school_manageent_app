...
require_once("../classes/Staff.php");
require_once("../classes/ExamRecords.php");
...
$studentRec = $examRecord ->display_exam_table_record($student_id,$term_id,  $school_session_id);
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
										...
										<thead>
											...
											<tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
												...
												<th class="text-end min-w-100px">Subject</th>
												<th class="text-end min-w-100px">ca1</th>
												<th class="text-end min-w-100px">ca2</th>
												<th class="text-end min-w-100px">Exam Score</th>
											...
											<tr>
												...
												<td class="d-flex align-items-center">
													...
													<div class="d-flex flex-column">
														<div style="text-align:ri" class="text-gray-800 text-hover-primary mb-1"><?php echo   $row['Name']; ?></div>
												...
												<!--begin::Last login=-->
												<td>
													<div class="badge badge-light fw-bolder"><?php echo   $row['ca2']; ?></div>
												</td>
												<!--end::Last login=-->
												<!--begin::Two step=-->
												<td>
													<div class="badge badge-light-success fw-bolder"><?php echo   $row['examinations']; ?></div>
												</td>
												...
												<td class="text-end">
													...
													<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
														...
														<div class="menu-item px-3">
															<a href="<?php echo './exam/student_class_exam_rec.php?id='.urlencode($subject_id) ; ?>" class="menu-link px-3">Edit Student</a>
