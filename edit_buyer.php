                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Click on the Edit buyer link to edit buyer information.
                        </div>
...
require_once('includes/connection.class.php');
       ...
       $stmt = $conn->prepare("SELECT * FROM buyer_tb");
		...
		while($row = $stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			<td align="center">
			<a id="<?php echo $id; ?>" href="#buyer<?php echo $id; ?>" data-toggle="modal" class="btn btn-success" title = "edit buyer info"> <span class=" glyphicon glyphicon-edit"></span> 
			Edit Buyer
            </a>
			
			<?php include('modal_edit_buyer.php'); ?>
			</td>
